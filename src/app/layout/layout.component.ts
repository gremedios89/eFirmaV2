...
export class LayoutComponent implements OnInit, OnDestroy {
    config: FuseConfig;
    //layout: string;
    layout: string = 'classic'; // definiendo el estilo de la plantilla a Classic
    scheme: 'dark' | 'light';
    theme: string;
    ...
    ngOnInit(): void {
        ...
        if(localStorage.getItem('accessToken')){
            //this._userService.user = JSON.parse(localStorage.getItem('profile'));
            this._userService.user = AuthUtils._decodeToken(localStorage.getItem('accessToken'));
            //this._userService.user$.subscribe(resp => console.log(resp));
        }
    }
